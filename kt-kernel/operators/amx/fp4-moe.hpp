    ...
    for (int m_idx = 0; m_idx < m; m_idx++) {
      ...
      for (; n_pos + 4 <= n_end; n_pos += 4) {
        ...
        for (int g = 0; g < kg_count; g++) {
          _mm_prefetch((const char*)&w0[g + 1], _MM_HINT_T0);
          _mm_prefetch((const char*)&w1[g + 1], _MM_HINT_T0);
          _mm_prefetch((const char*)&w2[g + 1], _MM_HINT_T0);
          _mm_prefetch((const char*)&w3[g + 1], _MM_HINT_T0);
