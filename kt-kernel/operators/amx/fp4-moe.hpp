...
struct GemmKernel224MXFP4SmallKGroup {
  ...
  struct DequantizedWeight {
      ...
      __attribute__((always_inline)) DequantizedWeight(__m128i w) {
          ...
          __m512 lut = _mm512_setr_ps(0.0f, 0.5f, 1.0f, 1.5f, 2.0f, 3.0f, 4.0f, 6.0f,
  ...
  __attribute__((always_inline)) static inline __m512 mxfp4_dot_bf16(const DequantizedWeight& w, const ActivationBF16& act) {
  #if defined(__AVX512BF16__)
